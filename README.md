...
4. Using the `kubectl cypher` plugin (install using Krew or download from a latest release)
5. Creating a [Cyphernetes DynamicOperator](https://github.com/avitaltamir/cyphernetes/blob/main/operator/test/e2e/samples/dynamicoperator-ingressactivator.yaml) using the cyphernetes-operator to define powerful Kubernetes workflows on-the-fly
6. Using the Cyphernetes API in your own Go programs.
...
* _Enhancements, Bug fixes and Improvements:_
  * [James Kim](https://github.com/jameskim0987)
  * [Vinicius Artur](https://github.com/viniciusartur)
  * [Noé Tarbouriech](https://github.com/noetarbouriech)
  * [Michael Darin](https://github.com/mdarin)
  * [Anand Francis Joseph](https://github.com/anandf)
